...
public class PDFBoxDemo
{
    ...
    public static void main( String[] args ) throws Exception {
        try {
            ...
            String songPath = MessageFormat.format("{0}/pdfbox/src/main/resources/song.png", System.getProperty("user.dir"));
            PDImageXObject pdImage = PDImageXObject.createFromFile(songPath, document);
            contentStream.drawImage(pdImage, 480, 10, 100, 100);
            contentStream.close();
            document.save(new File( System.getProperty("user.dir") + "/pdfbox/new_VAT_INVOICE.pdf"));
            document.close();
        } catch (Exception e) {
            e.printStackTrace();
        }
